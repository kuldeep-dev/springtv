...
//    console.log(req.body.image);
    ...
    s3.putObject(data, function(err, data){
        console.log("https://s3.us-gtv/"+randomString+".jpg");
        var pro_pic = "https://s3.ingtv/"+randomString+".jpg";
...
//    });
    ...
    s3.putObject(data, function(err, data){
        console.log("https://s3.us-ingtv/"+randomString+".jpg");
        var pro_pic = "https://s3.us-ngtv/"+randomString+".jpg";
        if (err) { 
          console.log(err);
